...
class zEditor(Screen):
    ...
    skin = """
        <screen name="zEditor" position="40,80" size="1900,900" title="zEditor">
            <widget name="list_head" position="8,10" size="1850,45" font="Regular;22" foregroundColor="#00fff000" />
            <widget name="filedata" scrollbarMode="showOnDemand" itemHeight="50" position="10,60" size="1850,750" itemHeight="50" />
